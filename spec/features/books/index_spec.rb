...
RSpec.describe 'book index page', type: :feature do
  it 'shows book and all associated attributes' do 
    ...
    book1 = Book.create!(name: "Feet of Clay", read: false, read_time: 7, bookshelf_id: shelf.id)
    book2 = Book.create!(name: "Three Guineas", read: false, read_time: 17, bookshelf_id: shelf.id)
